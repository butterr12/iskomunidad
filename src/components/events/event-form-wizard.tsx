...
export function EventFormWizard({ mode, initialData, autoApprove = true }: EventFormWizardProps) {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      {mode === "edit" && !autoApprove && initialData?.status === "approved" && (
        <div className="mx-4 mb-3 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800 dark:border-amber-900 dark:bg-amber-950 dark:text-amber-200">
      ...
      {/* Footer buttons */}
      <div className="fixed bottom-0 inset-x-0 z-10 border-t bg-background p-4">
