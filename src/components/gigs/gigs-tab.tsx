...
import { Bookmark, Hammer, Briefcase } from "lucide-react";
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="mx-auto flex w-full max-w-5xl gap-4 p-4">
          ...
          <div className="min-w-0 flex-1 max-w-2xl mx-auto lg:mx-0">
            {/* Welcome banner */}
            {!selectedGig && (
              <div className="mb-3 rounded-2xl bg-gradient-to-r from-emerald-500/10 via-emerald-500/5 to-transparent border border-emerald-500/10 px-5 py-4">
                <p className="text-base font-semibold">Looking for a gig, isko?</p>
